...
## What I Do
- **Full-Stack Development**: I Design, develop, and deploy responsive, SEO-optimized websites and web applications using **Ms. Viso** and **Figma** for designing; **HTML/CSS**, **JavaScript**, **C#**, **SQL** and modern frameworks such as **React**, **Node.js**, and **ASP.NET** for development and database management.
...
- Relaxing on the beach or near water bodies while brainstorming creative ideas.
- Getting lost in a good book and exploring new perspectives.
- Indulging in my fascination with aviation. I enjoy learning to fly and learning about aircraft, overall, I just enjoying the beauty of flight.
